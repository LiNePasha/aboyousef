      ...
      <div>
        ...
        <div className="p-2.5 border-2 border-yellow-200 bg-yellow-50 rounded-lg md:p-3">
          <div className="space-y-1 text-xs">
            ...
            <p>📱 <a href={`tel:+2${process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}`} className="underline text-brand-600">{process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}</a></p>

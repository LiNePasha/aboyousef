...
const FACEBOOK_URL = process.env.NEXT_PUBLIC_FACEBOOK_URL || 'https://www.facebook.com/aboyousef'
const TIKTOK_URL = process.env.NEXT_PUBLIC_TIKTOK_URL || 'https://www.tiktok.com/@aboyousef'
const CONTACT_PHONE = process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'
const CONTACT_EMAIL = process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aboyousef@spare2app.com'
const VENDOR_NAME = process.env.NEXT_PUBLIC_VENDOR_NAME || 'ابو يوسف'
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">قطع غيار أصلية</p>
              </div>
            </div>
            <p className="mb-6 text-sm leading-relaxed text-gray-400">
              متجرك الموثوق لأكسسوارات وقطع غيار الموتوسيكلات الأصلية في مصر. جودة عالية، أسعار تنافسية، وخدمة ممتازة.
            </p>

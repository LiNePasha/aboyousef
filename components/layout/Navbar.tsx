        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10 text-xs">
            <div className="flex items-center gap-6 text-gray-600">
              <a href={`tel:${process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}`} className="flex items-center gap-1.5 hover:text-primary-600 transition-colors">
                <PhoneIcon className="w-4 h-4" />
                <span className="font-medium">{process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}</span>
              </a>
              <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aboyousef@spare2app.com'}`} className="flex items-center gap-1.5 hover:text-primary-600 transition-colors">
                <EnvelopeIcon className="w-4 h-4" />
                <span>{process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aboyousef@spare2app.com'}</span>
              </a>
            </div>
        ...
        <div className="fixed inset-0 z-[100000000] flex">
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-5 border-b border-gray-200 bg-gradient-to-r from-primary-50 to-blue-50">
              <OptimizedImage src="/logo.webp" alt="ابو يوسف" width={200} height={79} className="w-20 h-20" />
              <button
                type="button"
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="px-4 py-4 space-y-2 border-t border-gray-200 bg-gray-50">
                <a href={`tel:${process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}`} className="flex items-center gap-2 text-sm text-gray-600 transition-colors hover:text-primary-600">
                  <PhoneIcon className="w-4 h-4" />
                  <span>{process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}</span>
                </a>
                <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aboyousef@spare2app.com'}`} className="flex items-center gap-2 text-sm text-gray-600 transition-colors hover:text-primary-600">
                  <EnvelopeIcon className="w-4 h-4" />
                  <span>{process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aboyousef@spare2app.com'}</span>
                </a>

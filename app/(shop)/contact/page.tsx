  ...
  const contactInfo = [
    {
      icon: PhoneIcon,
      title: 'رقم الهاتف',
      value: process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314',
      href: `tel:${process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}`,
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <motion.a
              ...
              href={`https://wa.me/${process.env.NEXT_PUBLIC_CONTACT_PHONE?.replace(/\D/g, '') || '01144747314'}`}
              target="_blank"
          ...
          >
            ...
            <div className="overflow-hidden bg-white border shadow-xl rounded-3xl border-gray-200/50">
              <div className="p-8 text-center">
                ...
                <a
                  href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aboyousef@spare2app.com'}`}

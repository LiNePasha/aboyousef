...
export const metadata: Metadata = {
  title: 'سياسة الخصوصية - ابو يوسف',
  description: 'سياسة الخصوصية وحماية البيانات في متجر ابو يوسف. نحن ملتزمون بحماية خصوصيتك',
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="leading-relaxed text-gray-700">
                نحن في <strong>ابو يوسف</strong> نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية. 
            ...
            <section>
              ...
              <div className="p-6 text-white bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl">
                ...
                <ul className="space-y-2">
                  <li>📧 البريد: {process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'aboyousef@spare2app.com'}</li>
                  <li>📱 الهاتف: {process.env.NEXT_PUBLIC_CONTACT_PHONE || '01144747314'}</li>
                </ul>

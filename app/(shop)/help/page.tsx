...
export const metadata: Metadata = {
  title: 'مركز المساعدة - ابو يوسف',
  description: 'مركز المساعدة والدعم الفني لمتجر ابو يوسف. نحن هنا لمساعدتك في أي استفسار أو مشكلة',
  keywords: 'مساعدة, دعم فني, خدمة العملاء, ابو يوسف, قطع غيار موتوسيكلات',
}
